 ...
 */
public class Pkcs11ExtendedDecrypter extends ExtendedDecrypter {

  /** Class logger. */
  private final Logger log = LoggerFactory.getLogger(Pkcs11ExtendedDecrypter.class);
   ...
   */
  public Pkcs11ExtendedDecrypter(DecryptionParameters params) {
    super(params);
   ...
   */
  public Pkcs11ExtendedDecrypter(KeyInfoCredentialResolver newResolver, KeyInfoCredentialResolver newKEKResolver,
