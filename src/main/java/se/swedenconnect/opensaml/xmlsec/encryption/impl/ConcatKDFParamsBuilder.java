...
/**
 * Builder for {@link ConcatKDFParams}.
 * 
 * @author Martin Lindström (martin@idsec.se)
 * @author Stefan Santesson (stefan@idsec.se)
 */
public class ConcatKDFParamsBuilder extends AbstractXMLObjectBuilder<ConcatKDFParams> implements XMLEncryptionBuilder<ConcatKDFParams> {

  /** {@inheritDoc} */
  public ConcatKDFParams buildObject() {
    return buildObject(EncryptionConstants.XMLENC11_NS, ConcatKDFParams.DEFAULT_ELEMENT_LOCAL_NAME, EncryptionConstants.XMLENC11_PREFIX);
  }
